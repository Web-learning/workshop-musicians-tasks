# Howzit! Welcome to Weblearning 👋🏽

My name is Derek Moore. This is where I document, publish and collaborate on projects. 
Welcome to [Weblearning](https://weblearning.co.za/)

# Workshop tasks (for musicians) 
A collection of tasks for musicians to complete so that they get onto the [knowledge graph](https://weblearning.co.za/blog/knowledge-graph/)
* Have we agreement on an [agenda](https://mensuel.framapad.org/p/Musicians)?
* Have you read my blog post about a [connected musician](https://weblearning.co.za/blog/a-connected-musician/). There also is a hidden presentation there. Do not stress about comprehension or completion. 
* Have you looked at my [Knowledge Panel](https://www.google.com/search?kgmid=/g/11x2l8yhp3) Its pretty weak. The presentation has Rubý's, Chris and Ian's knowledge panels. 
## Questions, reflections and thoughts
# Please bring
* Geolocation information. Your venue(s)can be listed at [concerts venue map](data/concerts.geojson)?
